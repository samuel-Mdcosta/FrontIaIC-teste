    ...
    <main className="pt-28 pb-20 px-6 max-w-6xl mx-auto">
      ...
      <section className="text-center py-16 space-y-6">
        ...
        <p className="text-on-surface-variant text-lg max-w-2xl mx-auto leading-relaxed">
          ...
          <span className="text-primary font-semibold">RAG</span>{" "}
          (Retrieval-Augmented Generation) que responde perguntas e gera
          questões fundamentadas exclusivamente em literatura acadêmica
          verificada — sem alucinações.
        </p>
      ...
      <section className="py-16 space-y-10">
        <div className="text-center space-y-2">
          <span className="text-primary font-headline text-2xl font-semibold">
            Como funciona
          </span>
          <p className="text-on-surface-variant text-sm max-w-xl mx-auto">
            O sistema recupera trechos relevantes de PDFs acadêmicos e passa
            esse contexto para o modelo de linguagem — garantindo respostas
            embasadas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 bg-surface-container-lowest rounded-2xl shadow-sm space-y-4 border border-outline-variant/10">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              PDFs de artigos e livros de neurociência são processados,
              fragmentados semanticamente e armazenados como vetores no MongoDB
              Atlas.
            </p>
          </div>
          ...
          <div className="p-8 bg-surface-container-lowest rounded-2xl shadow-sm space-y-4 border border-outline-variant/10">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              Cada pergunta é convertida em embedding pelo modelo Nomic v1.5. Os
              8 trechos mais relevantes da literatura são recuperados por
          ...
          <div className="p-8 bg-surface-container-lowest rounded-2xl shadow-sm space-y-4 border border-outline-variant/10">
            ...
            <p className="text-sm text-on-surface-variant leading-relaxed">
              O modelo Gemma 3 27B sintetiza a resposta usando apenas o contexto
              recuperado, eliminando alucinações comuns em LLMs de propósito
              geral.
            </p>
          </div>
        </div>
          ...
          <div className="p-8 bg-primary rounded-2xl text-white space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                Faça perguntas livres sobre neurociência. O tutor busca nas
                referências acadêmicas e responde com embasamento científico
                real.
              </p>
            </div>
            <button
          ...
          <div className="p-8 bg-surface-container-low rounded-2xl space-y-4 flex flex-col justify-between border border-outline-variant/10">
            <div className="space-y-3">
              ...
              <p className="text-on-surface-variant text-sm leading-relaxed">
                Gere questões de múltipla escolha fundamentadas na literatura.
                Configure o nível de dificuldade e a modalidade de feedback
                antes de começar.
              </p>
            </div>
            <button
